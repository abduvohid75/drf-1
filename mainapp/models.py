...
class Course(models.Model):
    ...
    is_changed = models.BooleanField(default=False, verbose_name='статус')

    subs = models.JSONField(verbose_name='подписчики', null=True, blank=True)

    def __str__(self):
        return f'{self.title} {self.desc} {self.subs}'
